...
public class Navigator_v3 {
	...
	public Navigator_v3(RobotCtrl robotCtrl, Odometer odometer) {
	...
	public void travelPath(Node destination) {
		...
		Node current = searchNode(14);// nodes[9][10];
	 ...
	 * @return nodes[x][y]
	 **/
	private Node convertToNode(double x, double y) {
		int xNode = 0;
		int yNode = 0;
		xNode = (int) x / 30;
		yNode = (int) y / 30;
