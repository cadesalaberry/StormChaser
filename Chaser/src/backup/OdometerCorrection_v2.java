...
public class OdometerCorrection_v2 implements TimerListener {
	...
	// constructors
	public OdometerCorrection_v2(RobotCtrl robotCtrl, LineSensor lineSensorL,
	...
	public double getDistanceFromTacho(int tachoValue, double radius) {
		return (double) (tachoValue / 180 * Math.PI * radius);
	}
